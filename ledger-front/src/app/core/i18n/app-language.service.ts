...
const translations: Record<TranslationKey, string> = {
  ...
  'category.color': 'Цвет',
  'category.expense': 'Поступление',
  'category.income': 'Доход',
  'category.loanDescription': 'Включайте только для категорий, которые должны уменьшать остаток выбранного кредита.',
  'category.loanLabel': 'Категория платежей по кредитам',
  'category.name': 'Название',
  'category.type': 'Тип',
  'dashboard.balance': 'Баланс',
  'dashboard.balanceHelp': 'Доходы минус поступления',
  'dashboard.categoryExpenses': 'Поступления по категориям',
  'dashboard.currentMonth': 'Текущий месяц',
  'dashboard.emptyExpenses': 'За этот месяц поступлений пока нет.',
  ...
  'dashboard.monthExpense': 'Поступления',
  ...
  'dashboard.todayExpenses': 'Поступления за сегодня',
  ...
  'nav.expenses': 'Поступления',
  'nav.incomes': 'Доходы',
  'nav.loans': 'Кредиты',
  'nav.server': 'Сервер',
  'nav.settings': 'Настройки',
  'nav.transactions': 'Операции',
  'settings.behavior': 'Поведение приложения',
  'settings.behaviorText':
    'После 18:00 приложение показывает диалог для быстрого внесения поступлений за день. Записи добавляются пачкой и могут уменьшать остаток по выбранному кредиту.',
  'settings.categories': 'Категории и параметры учета',
  'settings.expenseCategories': 'Поступления',
  ...
  'transactions.expense': 'Поступления',
  'transactions.expensesEmpty': 'Поступлений пока нет.',
  'transactions.expensesEyebrow': 'Списания',
  'transactions.expensesTitle': 'Поступления',
